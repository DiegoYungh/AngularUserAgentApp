...
factory('Agents', ['$resource', 'TokenHandler', function($resource, tokenHandler){
    var resource = $resource('/app_dev.php/api/agents', {}, { 
        query: {method:'GET', params:{}, isArray:true}
    });
    resource = tokenHandler.wrapActions(resource, ['get', 'save', 'query']);
    return resource;
}]).
factory('Agent', ['$resource', 'TokenHandler', function($resource, tokenHandler){
    var resource = $resource('/app_dev.php/api/agent/:id', {}, { 
        query: {method:'GET', params:{}}
    });
    resource = tokenHandler.wrapActions(resource, ['get', 'query']);
    return resource;
}]).
factory('Cookie', ['$resource', 'TokenHandler', function($resource, tokenHandler){
    var resource = $resource('/app_dev.php/api/stop_bother', {}, { 
        query: {method:'GET', params:{}},
    });
    resource = tokenHandler.wrapActions(resource, ['get', 'query']);
    return resource;
}]).
factory('UserInfo', ['$resource', 'TokenHandler', function($resource, tokenHandler){
    var resource = $resource('/app_dev.php/api/userInfo', {}, { 
        query: {method:'GET'},
    });
    resource = tokenHandler.wrapActions(resource, ['get', 'query']);
    return resource;
}]).
factory('Report', ['$resource', 'TokenHandler', function($resource, tokenHandler){
    var resource = $resource('/app_dev.php/api/report/:action', {}, { 
        query: {method:'GET', params: {'action': 'browser'}, isArray: true},
    });
    resource = tokenHandler.wrapActions(resource, ['get', 'query']);
    return resource;
}]).
